...
namespace Xero.Api.Tests.Integration.Contacts {
    ...
    public class Find : ContactsTest {
        ...
        public async Task find_by_page() {
            ...
            Assert.IsTrue((await Api.Contacts.Page(1).FindAsync()).Any());
        }
        ...
        public async Task find_by_value() {
            ...
            Assert.IsTrue(name.All(p => p == expected));
        }
        ...
        public async Task find_by_contains_value() {
            ...
            Assert.IsTrue(contacts.All(p => p.Contains(expected)));
        }
        ...
        public async Task find_by_status() {
            ...
            Assert.IsTrue(status.All(p => p == ContactStatus.Active));
        }
        ...
        public async Task find_by_updated_date() {
            ...
            Assert.IsTrue(contacts.Contains(expected));
        }
