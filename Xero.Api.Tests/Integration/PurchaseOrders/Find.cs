...
namespace Xero.Api.Tests.Integration.PurchaseOrders {
    public class Find : ApiWrapperTest {
        ...
        public async Task Find_purchase_orders() {
            ...
            Assert.IsTrue(foundPurchaseOrders.Any());
        }
        ...
        public async Task Filter_purchase_orders_by_ModifiedSince() {
            ...
            Assert.IsTrue(retrievedPurchaseOrders.All(p => p.Id != oldPurchaseOrder.Id));
            Assert.IsTrue(retrievedPurchaseOrders.Any(p => p.Id == newPurchaseOrder.Id));
        }
        ...
        public async Task Filter_purchase_orders_by_DateTo() {
            ...
            Assert.IsTrue(retrievedPurchaseOrders.All(p => p.Id != newPurchaseOrder.Id));
            Assert.IsTrue(retrievedPurchaseOrders.Any(p => p.Id == oldPurchaseOrder.Id));
        }
        ...
        public async Task Filter_purchase_orders_by_a_DateFrom_DateTo_date_range() {
            ...
            Assert.IsTrue(retrievedPurchaseOrders.Any(p => p.Id == midPurchaseOrder.Id));
        ...
        public async Task Use_multiple_filters_to_find_Purchase_orders() {
            ...
            Assert.IsTrue(purchaseOrders.Any());
        }
